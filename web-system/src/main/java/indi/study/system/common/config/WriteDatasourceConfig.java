...
// * */
//@Configuration
//@MapperScan(basePackages = WriteDatasourceConfig.MAPPER_PACKAGE, sqlSessionTemplateRef  = WriteDatasourceConfig.SESSION_FACTORY)
...
//
////    @Bean
////    public SqlSessionTemplate sqlSessionTemplate(@Qualifier(WriteDatasourceConfig.SESSION_FACTORY) SqlSessionFactory sqlSessionFactory) throws Exception {
